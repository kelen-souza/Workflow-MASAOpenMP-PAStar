...
@task(work_dir=IN, input_1=FILE_IN, input_2=FILE_IN, alignment_file= OUT)
...
@task(pair_dir=IN, alignment_file = FILE_IN, returns=dict)
def get_metrics(pair_dir, alignment_file, seq1_ac, seq2_ac):
     ...
     metrics = dict()
     with compss_open(alignment_file, "r") as f:
          text = f.read()
