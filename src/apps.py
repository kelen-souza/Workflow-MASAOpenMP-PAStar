...
@task(work_dir=IN, seq1=IN, seq2=IN, alignment_file=IN, seq_dir=IN, returns=(str, str, str))
...
@task(work_dir=IN, input_1=IN, input_2=IN, alignment_file=FILE_OUT)
...
@task(pair_dir=IN, alignment_file = IN, returns=dict)
